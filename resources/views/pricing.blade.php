...
<body>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    <h2 class="page-title white">Services Offers</h2>
        ...
        <div class="container">
            ...
            <div class="row margin-bottom-40">
                ...
                <div class="col-md-10 col-md-offset-1 text-center">
                    <h2 class="section-title">Optimized Services Offers</h2>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <!--begin pricing-box -->
                    <div class="pricing-box-blue-light">
                        ...
                        <div class="pricing-top">
                            ...
                            <p class="price"><span class="currency white">$</span> <span class="number white">299</span> <span class="month white">Monthly</span></p>
                        ...
                        <div class="pricing-bottom">
                            ...
                            <ul>
                                <li><i class="icon icon-check-mark-2"></i> Finnancial Charts</li>
                                <li><i class="icon icon-check-mark-2"></i> Personal Loans Support</li>
                                <li><i class="icon icon-check-mark-2"></i> Insurance Consult</li>
                                <li><i class="icon icon-check-mark-2"></i> Expert Advisors</li>
                                <li><i class="icon icon-check-mark-2"></i> Taxes Calculation</li>
                            </ul>
                            
                            <a href="" class="btn btn-pricing-blue-light">SUBSCRIBE TODAY</a>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="pricing-box-blue">
                        ...
                        <div class="pricing-top">
                            ...
                            <p class="price"><span class="currency white">$</span> <span class="number white">399</span> <span class="month white">Monthly</span></p>
                        ...
                        <div class="pricing-bottom">
                            ...
                            <ul>
                                <li><i class="icon icon-check-mark-2"></i> Finnancial Charts</li>
                                <li><i class="icon icon-check-mark-2"></i> Business Loans Support</li>
                                <li><i class="icon icon-check-mark-2"></i> Private Banking</li>
                                <li><i class="icon icon-check-mark-2"></i> Expert Advisors</li>
                                <li><i class="icon icon-check-mark-2"></i> Calculation Soft</li>
                            </ul>
                            
                            <a href="" class="btn btn-pricing-blue">SUBSCRIBE TODAY</a>
                ...
                <div class="col-sm-4">
                    ...
                    <div class="pricing-box-red">
                        ...
                        <div class="pricing-top">
                            ...
                            <p class="price"><span class="currency white">$</span> <span class="number white">499</span> <span class="month white">Monthly</span></p>
                        ...
                        <div class="pricing-bottom">
                            ...
                            <ul>
                                ...
                                <li><i class="icon icon-check-mark-2"></i> Business Loans Support</li>
                                <li><i class="icon icon-check-mark-2"></i> Private Banking</li>
                                <li><i class="icon icon-check-mark-2"></i> Expert Software</li>
                                <li><i class="icon icon-check-mark-2"></i> Audit Control</li>
                            </ul>
                            
                            <a href="" class="btn btn-pricing-red">SUBSCRIBE TODAY</a>
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <p>*With more than <span class="bold">320 clients</span>, we aim to offer premium <span class="bold">financial solutions</span> for you or your business.</p>
                </div>
                <!--end col-md-12-->
    ...
    <!--begin newsletter -->
    <div class="section-image-newsletter2">
            ...
            <div class="row">
                ...
                <!--begin col-md-10-->
                    <div class="col-md-10 col-md-offset-1 text-center">
                        ...
                        <p class="section-subtitle white margin-bottom-20">Subscribe for financial updates, insurance news, special offers, great advices from our advisers,<br> financial material that keeps you up to date. Please enter your email to be informed.</p>
                        ...
                        <form id="newsletter-form2" class="newsletter_form" action="php/newsletter.php" method="post">
                            <input id="email_newsletter2" name="nf_email" placeholder="Enter Your Email Address" type="email">  
                            <input value="SUBSCRIBE" id="submit-button-newsletter2" type="submit">
                        </form>
                        <!--end newsletter-form -->
                    </div>
                    <!--end col-md-6 -->
